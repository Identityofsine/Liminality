 ...
 * @returns 
 */
function _createStory(name, authorID, image, banner, content, abstract) {
	return 	{
		name:name,
		authorID:authorID,
		image:image,
		...
		date:0,
		abstract:abstract,
		content:[{content:content, authorID:authorID}],
	}
}
...
exports.stories = [
	...
	},
	{
		...
		date:0,
		abstract:'In a quiet suburban town, two playgrounds separate the rough and rowdy kids from the calm and quiet ones. As a child, the protagonist finds himself drawn to the peaceful plastic palace, where he encounters a girl named Elma and a boy named Hunt. Elma is worried about starting middle school, while Hunt remains relaxed and carefree. As the three sit in the playground unnoticed by the rest of the school, they contemplate the significance of their existence and the indifference shown by the teachers and authorities.',
	...
	_createStory("Untitled", 1, "images/story/untitled/image.png", "images/story/untitled/banner.png", `Wait, hold on a second. Do you see that? No? There’s a guy standing under the north building. I wouldn’t label him ominous just yet, he hasn’t done anything that justifies fear. It’s practically midnight… What do you think he’s doing out here? For a smoke? Then we’d see a faint red glow from his lips. I don’t think he's out here on any mission, those apartments carry a thick smell of humidity so it's not unreasonable to think he’s getting a fresh breath of air. You’ve never noticed these buildings? They’ve been here for about 5 years; you must have passed it before without paying any thought to it. C’mon. Here, let’s keep moving.

Do you know what was there before, my friend? Before these buildings, there was a small neglected home that had to be built in the 1910s. The timber shingles on the walls were starting to peel off and although the paint was vibrant -- yellow and white -- it screamed of decay. The front yard ended with the avenue we stand on now. Granted there was about 15 metres before the house reached the street but that doesn’t mean it wasn’t a stranger to hearing commuters and commotion throughout all the hours between day and night.

It was demolished a year and a half before construction began. All that was left was flatland with overgrown vegetation, trees that looked hollow and vines that threatened to suffocate you. In the middle of that flatland, there was a perfectly square hole where the house stood. They’ve even dug up the concrete walls of the basement. Imagine your normal routine: coming home, setting the keys on the table, and enjoying any type of entertainment that you can get your tired hands on, destroyed by one measly public domain notice. 

Try to ignore it and then your water goes out, a few days later you have no electricity. You’re forced to vacate yourself to continue a new monotonous existence. Then a few months later, if you decided to change yourself, that old routine becomes impossible to complete, a gaping hole where your old self laid, if you lived in that house before you were buried under those apartments. And depending who you were, it may have been the best thing that could have happened to you. 

I don’t blame you for feeling something sinister about an apartment complex overlooking an elementary school. I actually went there, I lived really close at the time before I moved. When I went, there was a gas station between the home and the school. It felt separate, but it felt right -- there was nothing off about it. But now that anyone, and I mean anyone could peek their head out of their window and be presented and entertained by children playing, casts an ugly shadow upon those kids and a constant paranoia in the parents. It’s food for thought to think that the guy outside the north building has ever stuck his head out on his balcony, not for fresh air but to “see the commotion.” 

It’s borderline slander to assume something like that about a random person. With no background or even a clear picture of his face, it's criminal to assume rightful prejudice. But we are humans after all, prejudice and judgement is what we do. I don’t think we would have gotten this far in evolution if we didn’t use our judgement… Whether that judgement was rational or not isn’t important. 

I’m glad you picked up on that. The school exactly looks like an old church because at one point, in its archaic history, it was. It was built in 1929 strictly as a Lutheran church. However as the community grew and people started to come here from the city, schools needed to be built. Instead of building a new one they repurposed what was already good. They built these rectangular extensions on both sides of the auditorium, the place where everybody came and prayed. Shortly after, nobody came into the church to pray anymore and its history was long forgotten. It became an elementary school and as the years went on, less and less of god showed up.
`, "Can a degenerate ever become normal? And if they do... could they ever forgive themselves? (Credit to A.I for the really weird photos...)"),
]
