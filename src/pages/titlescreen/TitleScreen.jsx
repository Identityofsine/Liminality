...
function OpenedStory({story = {name:'',image:'',imagebanner:''}}) {
  return(
      ...
      <div className='card left'>
        <div className='card-container'>
          ...
          <div className={`story-container`}>
            {stories.map((d,i) => (<div className={`story ${clicked && currentStory === d ? 'forcehover' : ''}`} onClick={() => {handleStoryClick(d)}} onMouseEnter={() => {if(clicked) return; setStory(d)}} style={{backgroundImage:`url("${d.image}")`}}/>))}
